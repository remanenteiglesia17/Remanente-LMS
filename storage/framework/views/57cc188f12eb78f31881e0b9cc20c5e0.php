                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle" style="min-width:90px">
                                            ...
                                            <span class="estado-final" id="estado-<?php echo e($estudiante->id); ?>">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pesoBD > 0): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($aprobadoBD): ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-UPDATE\resources\views/profesor/calificaciones/index.blade.php ENDPATH**/ ?>