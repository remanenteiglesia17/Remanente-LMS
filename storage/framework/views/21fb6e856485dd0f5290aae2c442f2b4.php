...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.inscripciones.index')); ?>" method="GET" class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <select name="estado" class="form-control">
                            ...
                            <option value="reprobado" <?php echo e(request('estado') == 'reprobado' ? 'selected' : ''); ?>>Reprobado</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo e(route('admin.inscripciones.index')); ?>" class="btn btn-secondary btn-block">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-Re\resources\views/admin/inscripciones/index.blade.php ENDPATH**/ ?>