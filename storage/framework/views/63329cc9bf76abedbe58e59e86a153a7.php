    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createForm" action="<?php echo e(route('admin.secretarias.store')); ?>" method="POST" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-3">
...
<?php /**PATH C:\xampp\htdocs\www\Canvas-Church60\resources\views/admin/secretarias/create.blade.php ENDPATH**/ ?>