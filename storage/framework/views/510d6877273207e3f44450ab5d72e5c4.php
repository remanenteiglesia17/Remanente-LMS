                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($config->logo): ?>
                                            <div class="mb-3 text-center">
                                                <img src="<?php echo e(asset('storage/' .$config->logo)); ?>" alt="Logo actual"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Remanente\Canvas-Church60\resources\views/admin/config/edit.blade.php ENDPATH**/ ?>