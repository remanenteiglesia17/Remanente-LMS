...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($miHorario) && ($esProfesor || Auth::user()->estudiante)): ?>
        <div class="row">
            <div class="col-12">
                        ...
                        <table class="table table-striped mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Hora</th>
                                    <th>Curso</th>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($esProfesor === false && Auth::user()->estudiante): ?>
                                        <th>Profesor</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $miHorario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $horario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e(ucfirst(strtolower($horario->dia))); ?></td>
                                        <td><?php echo e($horario->hora_inicio->format('h:i A')); ?> - <?php echo e($horario->hora_fin->format('h:i A')); ?></td>
                                        <td><?php echo e($horario->cursos->pluck('nombre')->join(', ')); ?></td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($esProfesor === false && Auth::user()->estudiante): ?>
                                            <td>
                                                <?php echo e($horario->profesores->map(fn($p) => $p->nombres . ' ' . $p->apellidos)->join(', ')); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-UPDATE\resources\views/admin/index.blade.php ENDPATH**/ ?>