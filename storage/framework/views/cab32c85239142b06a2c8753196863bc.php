                    ...
                    <div class="card shadow-sm h-100 mb-0">
                        <div class="card-header bg-<?php echo e($meta['color']); ?> text-white">
                            <h3 class="card-title font-weight-bold">
                                <i class="fas <?php echo e($meta['icon']); ?>"></i> <?php echo e($meta['label']); ?> (Puntos: <?php echo e(number_format($grupo['peso_total'], 2)); ?>)
                            </h3>
                        </div>
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $grupo['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo e(number_format($calif->nota_maxima, 2)); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-UPDATE\resources\views/estudiante/calificaciones/por-curso.blade.php ENDPATH**/ ?>