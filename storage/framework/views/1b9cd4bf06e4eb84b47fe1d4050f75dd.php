...
<div id="nav-curso-fixed" class="bg-white border-bottom"  style="position: sticky; top: 57px; z-index: 1020;">
    <h1>Curso: <?php echo e($curso->nombre); ?></h1>

<p class="text-muted"><?php echo e($curso->codigo); ?> · <?php echo e($curso->periodo); ?></p>
...
<?php /**PATH C:\laragon\www\Remanente\Canvas-Church5\resources\views/admin/cursos/dynamic/nav.blade.php ENDPATH**/ ?>