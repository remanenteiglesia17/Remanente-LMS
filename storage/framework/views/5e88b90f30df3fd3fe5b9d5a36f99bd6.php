                        ...
                        <div class="col-md-2 col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="horas_requeridas"
                                    value="<?php echo e(old('horas_requeridas')); ?>" required>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['horas_requeridas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-UPDATE\resources\views/admin/cursos/create.blade.php ENDPATH**/ ?>