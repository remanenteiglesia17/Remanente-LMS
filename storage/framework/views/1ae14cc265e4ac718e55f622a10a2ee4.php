...
<a href="<?php echo e($dashboard_url); ?>"
    ...
    <img src="<?php echo e(asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/AdminLTELogo.png'))); ?>"
        alt="<?php echo e($config->site_name ?? 'AdminLTE'); ?>"
...
<?php /**PATH C:\laragon\www\Remanente\Canvas-Church60\resources\views/vendor/adminlte/partials/common/brand-logo-xs.blade.php ENDPATH**/ ?>