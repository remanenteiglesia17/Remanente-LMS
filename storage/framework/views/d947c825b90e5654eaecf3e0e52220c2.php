                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-curso="<?php echo e($tarea->curso_id); ?>">
                                ...
                                <td><?php echo e($tarea->fecha_entrega ? \Carbon\Carbon::parse($tarea->fecha_entrega)->format('d/m/Y H:i') : 'Sin fecha'); ?>

                                </td>
                                <td><span class="badge badge-light"><?php echo e(number_format($tarea->puntaje, 1)); ?></span></td>
                                <td><span class="badge badge-primary"><?php echo e(number_format($tarea->peso, 0)); ?>%</span></td>
                                <td>
                                    <span class="badge badge-info"><?php echo e($tarea->entregas->count()); ?> entregas</span>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('admin.profesor.tareas.show', $tarea->id)); ?>" class="btn btn-sm btn-info"
                                        title="Ver">
                                ...
                                <td>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.profesor.tareas.destroy')): ?>
                                        <form id="delete-form-<?php echo e($tarea->id); ?>"
                                            action="<?php echo e(route('admin.profesor.tareas.destroy', $tarea->id)); ?>" method="POST"
                                            style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" class="btn btn-sm btn-danger btn-delete"
                                                data-id="<?php echo e($tarea->id); ?>" data-text="¿Estás seguro de eliminar esta tarea?">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-UPDATE\resources\views/profesor/tareas/index.blade.php ENDPATH**/ ?>