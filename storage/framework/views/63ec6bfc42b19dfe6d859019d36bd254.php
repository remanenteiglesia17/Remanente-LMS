...
<head>
    ...
    <style>
            /* 2. Segundo Nivel (Módulo 1, 2...) - El azul suave que propusiste pero más refinado */
            .nav-treeview .nav-item.menu-open > .nav-link { 
                background-color: #4b646a !important; /* Un azul grisáceo profesional */
                color: #fff !important;
            }

            /* 3. Tercer Nivel (Propositos, Contenido) - Transparente con texto claro */
            .nav-treeview .nav-treeview .nav-link.active {
                background-color: rgba(255, 255, 255, 0.1) !important; 
                color: #fff !important; /* Azul brillante solo para el texto final */
                font-weight: bold;
            }
    </style>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!config('adminlte.enabled_laravel_mix')): ?>
...
<?php /**PATH C:\laragon\www\Remanente\Canvas-Church60\resources\views/vendor/adminlte/master.blade.php ENDPATH**/ ?>