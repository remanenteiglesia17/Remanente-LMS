                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control"
                            value="<?php echo e(old('fecha_inicio', optional($curso->fecha_inicio)->format('Y-m-d'))); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="fecha_fin" id="fecha_fin" class="form-control"
                            value="<?php echo e(old('fecha_fin', optional($curso->fecha_fin)->format('Y-m-d'))); ?>">
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\www\Remanente-LMS-Re\resources\views/admin/cursos/dynamic/descripcion.blade.php ENDPATH**/ ?>