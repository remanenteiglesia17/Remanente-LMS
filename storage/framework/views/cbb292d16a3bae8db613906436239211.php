            ...
            <div class="card">
                <div class="card-header bg-primary">
                    ...
                    <div class="card-tools d-flex align-items-center gap-1" style="gap:6px">
                        ...
                        <a href="<?php echo e(route('estudiante.calificaciones.por-curso', $curso->id)); ?>" class="badge badge-light ml-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($puedeDescargar): ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\Canvas-Church60\resources\views/estudiante/calificaciones/index.blade.php ENDPATH**/ ?>