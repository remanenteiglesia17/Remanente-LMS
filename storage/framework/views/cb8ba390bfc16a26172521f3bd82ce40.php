...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.usermenu_image')): ?>
            <img src="<?php echo e(asset('storage/' . Auth::user()->profile_photo_path)); ?>" onerror="this.onerror=null; this.src='<?php echo e(Auth::user()->adminlte_image()); ?>';"
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile_url): ?>
                ...
                <a href="<?php echo e(route('admin.profile.index')); ?>" class="nav-link btn btn-default btn-flat d-inline-block">
...
<?php /**PATH C:\laragon\www\Remanente\Canvas-Church60\resources\views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>